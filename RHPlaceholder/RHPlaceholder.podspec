#
#  Be sure to run `pod spec lint Stringer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://robert.herdzik.com"
  ...
  s.authors            = { "Robert Herdzik" => "robert.herdzik@yahoo.com" }
  ...
  s.source       = { :git => "http:github.com", :tag => "#{s.version}" }
